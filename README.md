...
<p align="center">
  <img src="https://github.com/FatalDecomp/ROLLER/blob/master/images/roller.ico?raw" width="128" />
</p>


| Latest Nightly Release | Upstream URL |
| :---: | :---: |
| [Click here](https://github.com/pkgforge-dev/ROLLER-AppImage/releases/latest) | [Click here](https://github.com/FatalDecomp/ROLLER) |

</div>

### ⚠️ Place `fataldata` inside `~/.local/share/roller` and run `./Roller-x-anylinux-x.AppImage --whiplash-root ~/.local/share/roller` ⚠️
